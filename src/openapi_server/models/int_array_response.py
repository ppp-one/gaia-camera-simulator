...
class IntArrayResponse(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    IntArrayResponse - a model defined in OpenAPI

        Value: The value of this IntArrayResponse [Optional].
        ClientTransactionID: The client_transaction_id of this IntArrayResponse [Optional].
        ServerTransactionID: The server_transaction_id of this IntArrayResponse [Optional].
        ErrorNumber: The error_number of this IntArrayResponse [Optional].
        ErrorMessage: The error_message of this IntArrayResponse [Optional].
    """

    Value: Optional[List[int]] = Field(alias="Value", default=None)
...
IntArrayResponse.update_forward_refs()
