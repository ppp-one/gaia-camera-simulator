...
class IntResponse(BaseModel):
    ...
    IntResponse - a model defined in OpenAPI

        Value: The value of this IntResponse [Optional].
        ClientTransactionID: The client_transaction_id of this IntResponse [Optional].
        ServerTransactionID: The server_transaction_id of this IntResponse [Optional].
        ErrorNumber: The error_number of this IntResponse [Optional].
        ErrorMessage: The error_message of this IntResponse [Optional].
    """
...
IntResponse.update_forward_refs()
